...
/*
 * OBS! THIS IS A COPY FROM THE ORIGINAL CLASS JUST FOR TESTING
 */

/**
 * Description of ImageProccessor "JUST FOR TESTING"
 * This class is only for testing, including some static variables data
 * for testing
 *
 * @author Sam Almen
 */
class ImageProccessor {
  ...
  public function getImageLinks($postUrl) {
    $postUrl = 'http://www.bouvet.se/images/logo-bouvet.png';
    if (isset($postUrl)) {
